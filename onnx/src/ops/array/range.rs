...
pub fn range(_ctx: &ParsingContext, _node: &NodeProto) -> TractResult<(Box<dyn InferenceOp>, Vec<String>)> {
    Ok((Box::new(Range::new(DatumType::I64)), vec![])) // Model works on long (i64) elements
}
